	...
	<div>
		...
		<b-modal ref="sign-up-modal" id="sign-up-modal" static>
			...
			<form>
				...
				>
					<b-form-input class="text-center" id="email-input" v-model="email" required></b-form-input>
				</b-form-group>
				<b-form-group
					label="First Name"
				...
				>
					<b-form-input class="text-center" id="first-name-input" v-model="first_name" required></b-form-input>
				</b-form-group>
				<b-form-group label="Surname" label-for="surname-input" invalid-feedback="Name is required">
					<b-form-input class="text-center" id="surname-input" v-model="last_name" required></b-form-input>
				</b-form-group>
				<b-form-group
					label="Password"
			...
			<template v-slot:modal-footer>
				...
				<b-button variant="outline-primary" @click="createNewUser">Register</b-button>
			</template>
		</b-modal>
	</div>
</template>
