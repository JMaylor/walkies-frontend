        ...
        <div class="shader rounded">
          <b-jumbotron class="mt-4" bg-variant="transparent">
            ...
            <template v-slot:lead
              >Love your dog? So do we. That's why we want them to get the most
              out of their walks. Meet other likeminded people in your area and
              take your dogs for a walk together! Walkies, free
              forever.</template
            >
            ...
            />
            <b-button
              @click="signUpModalVisible = true"
              variant="info"
              class="m-3"
              >Click here to get started!</b-button
            >
            <br />
