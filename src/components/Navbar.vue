<template>
	<b-navbar type="dark" toggleable="md" variant="dark" fixed="top">
		...
		<b-collapse id="nav-collapse" is-nav>
			<b-navbar-nav>
				...
				<b-nav-item v-if="!loggedIn" @click.stop="signUpModalVisible = true">Register</b-nav-item>

				<Login v-if="loginModalVisible" v-on:close-modal="loginModalVisible = false" />
				<b-nav-item v-if="!loggedIn" @click.stop="loginModalVisible = true">Login</b-nav-item>
